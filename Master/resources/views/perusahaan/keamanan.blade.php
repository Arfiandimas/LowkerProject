        ...
        <div class="menu-parent uk-width-1-4@s uk-background-primary ">
                ...
                <div class="menu-kanan uk-width-1-2">
                        ...
                        {{ csrf_field() }}
                            ...
                            <h4>Password Baru</h4>
                            <input id="passwordbaru" name="passwordbaru" class="uk-input uk-width-1-3" type="password" placeholder="Masukkan Password Baru" >
                            <h4>Konfirmasi Password Baru</h4>
                            <input id="passwordkonfirm" name="passwordkonfirm" class="uk-input uk-width-1-3" type="password" placeholder="Konfirm Password" >
