...
@section('title','Terhubung Perusahaan')
    ...
    <div class="container-expand" uk-grid>
        ...
        <div class="menu-parent uk-width-1-4@s uk-background-primary ">
                ...
                <div class="menu-kanan uk-width-1-2">
                        <h2>Terhubung</h2>
                        <ul>
                            <li> <a href=""><img src="/ICON/google.png" alt="">Sambungkan</a> </li>
                            <li> <a href=""><img src="/ICON/facebook.png" alt="">Sambungkan</a> </li>
                            <li> <a href=""><img src="/ICON/twitter.png" alt="">Sambungkan</a> </li>
