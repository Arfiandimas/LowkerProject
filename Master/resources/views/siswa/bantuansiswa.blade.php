...
@section('content')
        ...
        <div class="container" uk-grid>
                    <div class="uk-width-1-4@m uk-background-primary ">
            ...
            <div class="uk-width-expand@m uk-padding-large uk-margin-medium-left">
                <h3 class=" uk-margin-medium-bottom uk-text-bold uk-margin-xlarge-bottom">Bantuan</h3>
